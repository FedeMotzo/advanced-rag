...
from query.excel_query_engine import ExcelQueryEngine, DEFAULT_PNL_INSTRUCTION
    ...
    def ingest(self, file_path: str):
        ...
        if ext in TextLoader.SUPPORTED_EXTENSIONS:
            ...
            for sheet_name in self.excel_loader.list_sheets():
                ...
                instruction = DEFAULT_PNL_INSTRUCTION if "pnl" in sheet_name.lower() or "p&l" in sheet_name.lower() else None

                self.excel_engine.register_sheet(scoped_name, df, instruction=instruction)
