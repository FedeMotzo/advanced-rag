...
def _reciprocal_rank_fusion(results_lists: List[List[Document]], k: int = 60) -> List[Document]:
    ...
    Formula: score(d) = Σ 1/(rank_i + k) per ogni lista i
    k=60 è il valore standard da Cormack et al. (2009).
    """
...
class RAGQueryEngine:
    ...
    def ask(self, question: str, k: int = 4) -> Dict:
        ...
        Args:
            ...
            k: Numero di documenti finali per la generazione.
        ...
        try:
            ...
            if self.hybrid_search:
                ...
                # Fonde con RRF e prendi i top
                fused_docs = _reciprocal_rank_fusion([embedding_docs, bm25_docs])
